...
public enum ErrorType {
    ...
    INVALID_USER_ID(1010,"Hesap bulunamadi" ,HttpStatus.BAD_REQUEST ),
    ACCOUNT_ALREADY_BANNED(1009,"Hesabiniz banlanmis aktif olamaz" ,HttpStatus.BAD_REQUEST ),
    INVALID_USERPROFILE_ID(1012,"Kullanici bulunamadi" ,HttpStatus.BAD_REQUEST ),
    AUTH_SERVICE_UNAVAILABLE(1013,"Auth servive kullanimdisi" ,HttpStatus.BAD_REQUEST ),
    USER_NOT_FOUND(1014,"User not found" ,HttpStatus.NOT_FOUND),
    USERPROFILE_ALREADY_ACTIVE(1015,"Kullanici hesabi zaten aktif edilmis" ,HttpStatus.BAD_REQUEST ),
    USERPROFILE_UPDATE_STATUS_FAILED(1016,"Statu degistirilirken hata meydana geldi" ,HttpStatus.BAD_REQUEST);
